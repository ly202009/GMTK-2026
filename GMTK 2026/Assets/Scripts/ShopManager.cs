...
public class Shop : MonoBehaviour
{
    ...
    private static (int property, string seal, Vector3 sealPosition, int cost)[] Properties =
    {
        ...
        (CardData.AutoPlay, "Autoplay", new Vector3(-.2f, -.1f, -.01f), 7),
        (CardData.BonusTime, "Bonus Time", new Vector3(0, -.45f, -.01f), 5),
        (CardData.WildCard, "wildcard", new Vector3(.25f, -15, -.01f), 7),
